...
- 모듈 종료 상태: **Redis 사이드카 부착·`/cache` 동작 중** (모듈 10 수행자는 Easy Auth 비활성 상태)
...
> ⏭️ **이전 모듈(08 또는 10)에서 이어서 같은 터미널로 진행 중이라면 이 단계는 건너뛰세요.**
...
이전 모듈: [10. (선택) Easy Auth](10-easy-auth.md) · 다음 모듈: [12. Auto Heal(선택)](12-autoheal-option.md) 또는 [13. 정리](13-cleanup.md)
